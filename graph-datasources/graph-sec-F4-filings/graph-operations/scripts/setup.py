#!/usr/bin/env python3
"""
Complete setup script for SEC Form 4 Insider Trading Knowledge Graph
Runs indexing and view materialization for optimal performance

Run this ONCE after loading your Form 4 data:
...
def verify_graph_loaded(db: Memgraph) -> bool:
    ...
    try:
        ...
        if count == 0:
            ...
            print("   python3 batch_process_f4.py")
            return False
...
def main():
    print("\n" + "="*70)
    print("SEC FORM 4 INSIDER TRADING KNOWLEDGE GRAPH - COMPLETE SETUP")
    print("="*70)
    ...
    if success_count == total_scripts:
        print("\n🚀 Your Form 4 knowledge graph is now optimized!")
        print("\nNext steps:")
        print("  1. Query insiders: MATCH (i:Insider) RETURN i LIMIT 10")
        print("  2. Query transactions: MATCH (t:Transaction) RETURN t LIMIT 10")
        print("  3. Query companies: MATCH (c:Company) RETURN c LIMIT 10")
        print("  4. Run batch processing: python3 batch_process_f4.py")
    else:
